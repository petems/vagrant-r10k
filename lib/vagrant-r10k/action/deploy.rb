  ...
  module R10k
    module Action
      ...
      class Deploy < Base
        ...
        PuppetForge.user_agent = "vagrant-r10k/#{VagrantPlugins::R10k::VERSION}"
        ...
        def deploy(env, config)
          ...
          begin
            ...
            @logger.debug("vagrant-r10k: creating R10K::Action::Puppetfile::Install task")
            task   = R10K::Action::Puppetfile::Install(puppetfile)
